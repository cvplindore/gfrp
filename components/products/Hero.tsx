...
const ProductHero = () => {
  ...
  const [heroproductss, setHeroProductss] = useState(null);

  useEffect(() => {
    axios
      .get("https://gfrp-india.onrender.com/api/product_page/") // your Django endpoint
      .then((response) => {
        setHeroProductss(response.data); // it's a single object, not an array
      })
      .catch((error) => {
  ...
  return (
    <section
      ...
      // }}
      style={{backgroundImage: `url(${heroproductss.image})` }}
    >
          ...
          <div className="hero_wrapper projects-page">
            <div className="hero_left-wrapper">
              ...
              <p
                ...
                dangerouslySetInnerHTML={{ __html: heroproductss.description }}
              >
